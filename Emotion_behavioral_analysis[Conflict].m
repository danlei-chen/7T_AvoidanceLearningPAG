%% subject-level plots
% emotion
%for s = [14,15,16,22,23,26,28,30,34,37,39,43,45,50,53,54,57,60,61,66,68,69,71,73,74,81,83,86,92,94]  
%problem: all after 94
% pain
%for s = [18,19,20,24,25,26,31,32,33,41,47,48,49,52,55,56,58,59,62,64,65,67,72,80,88,90,95,98]
...
for s = [18,19,20,24,25,26,31,32,33,41,47,48,49,52,55,56,58,59,62,64,65,67,72,80,88,90,95,98]  
    ...
    cs=cs+1; 
    [OUT(cs,:), output(cs), logistic_regression_mtx]=Emotion_behavioral_analysis_individual(s); 
