...
setenv PROJNAME painTest_noTask
...
rsync -ra $DATA/BIDS_fmriprep/fmriprep/ses-02/$SUBJ/func/*pain2_* /scratch/$USER/$SUBJ/$PROJNAME/BIDS_preproc/$SUBJ/func
...
rsync $SCRIPTPATH/model/{painTest_lvl1_model.py,painTest_lvl1_model_startup.sh} /scratch/$USER/$SUBJ/$PROJNAME/wrkdir/
chmod +x /scratch/$USER/$SUBJ/$PROJNAME/wrkdir/painTest_lvl1_model_startup.sh
cd /scratch/$USER
...
$IMAGE \
/scratch/wrkdir/painTest_lvl1_model_startup.sh
