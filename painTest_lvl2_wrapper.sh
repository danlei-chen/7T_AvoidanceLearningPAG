...
rsync $SCRIPTPATH/model/{painTest_lvl2_model.py,painTest_lvl2_model_startup.sh} /scratch/$USER/$PROJNAME/wrkdir/
chmod +x /scratch/$USER/$PROJNAME/wrkdir/painTest_lvl2_model_startup.sh
cd /scratch/$USER
...
$IMAGE \
/scratch/wrkdir/painTest_lvl2_model_startup.sh
